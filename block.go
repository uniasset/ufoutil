...
// Tx returns a wrapped transaction (ufoutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (ufoutil.Tx) for all
...
// instead provides easy access to wrapped versions (ufoutil.Tx) of them.
